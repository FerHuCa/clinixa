      ...
      <Panel title="Solicitar cita">
        <div className="grid gap-4 p-4 lg:grid-cols-2">
          ...
          <label className="block">
            <span className="text-xs font-medium uppercase text-muted-foreground">Servicio</span>
            <select
          ...
          <label className="block">
            <span className="text-xs font-medium uppercase text-muted-foreground">{slotsLoading ? "Cargando horarios" : "Horario disponible"}</span>
            <select
              className="mt-1 w-full input"
          ...
          <label className="block lg:col-span-2">
            ...
            <textarea
              className="mt-1 min-h-20 w-full resize-none input"
